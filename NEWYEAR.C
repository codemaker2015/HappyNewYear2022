...
void area()
{
	...
	outtextxy(110,50,"HAPPY NEW YEAR 2022");
	settextstyle (DEFAULT_FONT,HORIZ_DIR,1);
	outtextxy(10,370,"\"Optimism is the faith that leads to achievement."); 
	outtextxy(10,385,"Nothing can be done without hope and confidence.\" - Helen Keller");
	outtextxy(10,410,"Keep going! Happy Programming.");
}